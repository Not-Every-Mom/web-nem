...
import { MessageCircle, Users, Heart, ArrowRight, BookHeart } from "lucide-react";
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="text-center mb-20" data-animate>
          <h2 className="font-display text-3xl lg:text-4xl text-deep-green mb-6 font-bold tracking-tight">
            Three Pillars to Healing & Support
          </h2>
          <p className="font-sans text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed font-light">
            <span className="font-bold">Not Every Mom</span> offers personal AI companionship, community connection, and a library of curated resources — because everyone's healing journey is different.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="relative z-10 text-center space-y-6 h-full flex flex-col">
              ...
              <div className="space-y-4 flex-1">
                <h3 className="font-display text-2xl text-deep-green font-bold">
                  Your Personal <span className="font-extrabold">MOM AI</span>
                </h3>
                ...
                <div className="space-y-3 text-left">
                  <div className="flex items-center space-x-3">
                    <MessageCircle className="w-5 h-5 text-powder-blue" />
          ...
          >
            ...
            <div className="relative z-10 text-center space-y-6 h-full flex flex-col">
              ...
              <div className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-gentle focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-white/90 text-deep-green border border-deep-green/20 hover:bg-white hover:border-deep-green/30 backdrop-blur-sm h-11 px-8 group w-full">
                  <a href="https://discord.gg/CUDd268B2w"
                target="_blank"
          ...
          >
            ...
            <div className="relative z-10 text-center space-y-6 h-full flex flex-col">
              ...
              <div className="space-y-4 flex-1">
                ...
                <p className="font-sans text-muted-foreground leading-relaxed">
                  Access information, tools, and vetted resources to support your healing journey.
                </p>
                
                <div className="space-y-3 text-left">
                  <div className="flex items-center space-x-3">
                    <BookHeart className="w-5 h-5 text-deep-green" />
                    <span className="font-sans text-sm text-muted-foreground">Books and Articles to help you learn techniques for healing and coping with the impact of abuse and neglect</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <BookHeart className="w-5 h-5 text-deep-green" />
                    <span className="font-sans text-sm text-muted-foreground">Tutorials on all the things your Mom may have missed teaching you</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <BookHeart className="w-5 h-5 text-deep-green" />
                    <span className="font-sans text-sm text-muted-foreground">Links to programs and real world support systems to meet your needs in your community</span>
                  </div>
                </div>
              </div>                                  
            </div>
        ...
        <div className="mt-16 text-center" data-animate>
          <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-powder-blue/10 to-deep-green/10 rounded-full border border-powder-blue/20">
            ...
            <span className="font-sans text-deep-green font-medium">
              Choose one or all — your healing journey is uniquely yours
            </span>
          </div>
        </div>
      </div>
